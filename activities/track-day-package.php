...
<html class="no-js">
    <head>
        ...
        <title>SportBox - Track Day Package</title>
    ...
    <body>
        ...
        <div id="activities" class="container">
            <div class="activity-tiles">
                ...
                <script type="text/javascript" src="https://yourplacefull.com/api/assets/js/sportbox?listing=3-day-track-session-package"></script>
                <div id="pf-root"></div>
