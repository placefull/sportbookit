...
<html class="no-js">
    <head>
        ...
        <title>SportBox - Born to Race</title>
    ...
    <body>
        ...
        <div id="activities" class="container">
            <div class="activity-tiles">
                ...
                <script type="text/javascript" src="https://yourplacefull.com/api/assets/js/sportbox?listing=arrive---drive-at-sportbox"></script>
                <div id="pf-root"></div>
