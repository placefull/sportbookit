...
<html class="no-js">
    <head>
        ...
        <title>SportBox - Kick-back Summer Volleyball Tour</title>
    ...
    <body>
        ...
        <div id="activities" class="container">
            <div class="activity-tiles">
                ...
                <script type="text/javascript" src="https://yourplacefull.com/api/assets/js/sportbox?listing=kick-back-summer-volleyball-tour-9"></script>
                <div id="pf-root"></div>
